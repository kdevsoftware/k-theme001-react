            ...
            <Row>
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-numbers">46</div>
                  <div className="widget-subheading">Total Views</div>
                  <div className="widget-description text-success">
                    <FontAwesomeIcon icon={faAngleUp} />
                    <span className="pl-1">176</span>
                  </div>
                </div>
              </Col>
              <Col md="4">
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-numbers">5.82</div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-numbers">62.3</div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-numbers">2.82</div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-numbers">31.9</div>
